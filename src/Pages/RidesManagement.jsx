  ...
  return (
    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
      ...
      <button
        onClick={onRefresh}
        disabled={refreshing}
        className={`rounded-lg border border-gray-300 dark:border-gray-600 p-2 text-gray-600 dark:text-gray-400 transition-all hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-800 dark:hover:text-white disabled:opacity-50 ${
...
const RideCard = ({ ride, onTrack, onChat, getStatusBadge }) => {
  return (
    <div className="cursor-pointer rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 transition-all hover:border-gray-300 dark:hover:border-gray-500 hover:shadow-lg">
      <div className="mb-4 flex items-center justify-between">
        <h3 className="text-lg font-semibold text-gray-800 dark:text-white">#{ride.id}</h3>
